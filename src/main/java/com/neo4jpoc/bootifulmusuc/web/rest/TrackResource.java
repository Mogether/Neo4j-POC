...
/**
 * REST controller for managing {@link com.neo4jpoc.bootifulmusuc.domain.Track}.
 */
@RestController
@RequestMapping("/api")
public class TrackResource {
    ...
    public ResponseEntity<TrackDTO> updateTrack(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, trackDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<TrackDTO> partialUpdateTrack(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, trackDTO.getId())
        );
    }
     ...
     */
    @GetMapping("/tracks")
    public ResponseEntity<List<TrackDTO>> getAllTracks(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
