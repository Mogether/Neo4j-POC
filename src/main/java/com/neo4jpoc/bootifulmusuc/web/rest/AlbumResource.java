...
/**
 * REST controller for managing {@link com.neo4jpoc.bootifulmusuc.domain.Album}.
 */
@RestController
@RequestMapping("/api")
public class AlbumResource {
    ...
    public ResponseEntity<AlbumDTO> updateAlbum(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, albumDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<AlbumDTO> partialUpdateAlbum(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, albumDTO.getId())
        );
    }
