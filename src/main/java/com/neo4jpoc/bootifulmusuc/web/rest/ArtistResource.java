...
/**
 * REST controller for managing {@link com.neo4jpoc.bootifulmusuc.domain.Artist}.
 */
@RestController
@RequestMapping("/api")
public class ArtistResource {
    ...
    public ResponseEntity<ArtistDTO> updateArtist(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, artistDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ArtistDTO> partialUpdateArtist(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, artistDTO.getId())
        );
    }
